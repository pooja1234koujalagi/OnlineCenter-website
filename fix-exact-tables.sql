-- ========================================
-- EXACT TABLE STRUCTURE (Based on MySQL)
-- ========================================
-- Run this script in your Supabase SQL Editor

-- Drop existing tables and recreate with exact structure
DROP TABLE IF EXISTS uploads;
DROP TABLE IF EXISTS admin_info;
DROP TABLE IF EXISTS users;

-- Create users table (exact match to MySQL)
CREATE TABLE users (
...
-- Create uploads table (exact match to MySQL)
...
-- Create admin_info table (exact match to MySQL)
